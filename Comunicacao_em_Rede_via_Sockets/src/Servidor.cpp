...
int main(int argc, char const *argv[])
{
   ...
   // std::cout << "loja criada" << std::endl;
   // std::cout << "size MSG: " << sizeof(Mensagem)  << std::endl;
   // while (!loja.estoqueVazio()) {
      // threads.push_back(loja.receberMensagem());
      // std::cout << loja.estoqueVazio() << std::endl;
   // }
   ...
   //  char buffer[1024] = {0};
   //  char *hello = "Hello from server dale";
